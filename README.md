...
<p align="center">
  <img src="docs/plan.png" alt="计划管理" width="666">
</p>
...
<p align="center">
  <img src="docs/month.png" alt="月历视图" width="666">
</p>

- **今日任务** — 勾选完成，反馈记忆状态（记住/模糊/遗忘），一键延期或跳过。模糊和遗忘自动生成补救复习

<p align="center">
  <img src="docs/today.png" alt="今日任务" width="666">
</p>

- **标签筛选** — 笔记页按标签组织和搜索，支持批量导出 Markdown（含图片）

<p align="center">
  <img src="docs/note1.png" alt="标签筛选" width="666">
</p>

- **笔记系统** — 内置 Markdown 编辑器，支持 GFM 语法（标题、粗斜体、表格、代码块、任务列表、图片粘贴），可导出为 Markdown 文件

<p align="center">
  <img src="docs/note2.png" alt="笔记系统" width="666">
</p>

- **薄弱追踪** — 遗忘或模糊的知识点自动标记“薄弱”，进度页集中查看和复习

<p align="center">
  <img src="docs/progress.png" alt="薄弱追踪" width="666">
</p>
...
<p align="center">
  <img src="docs/settings1.png" alt="设置页面：数据备份与云存档" width="666">
</p>

<p align="center">
  <img src="docs/settings2.png" alt="设置页面：外观主题与系统设置" width="666">
</p>
